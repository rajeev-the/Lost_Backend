...
SECRET_KEY = 'django-insecure-wn8k#_nc)lm20ptrdnm3x5#)3q@jod@ha86d*0#*#(=cd+k01_'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",  # For example, if your frontend is running on localhost:3000
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Destination for collectstatic command
